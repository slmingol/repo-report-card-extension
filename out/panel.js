...
class RepoReportCardPanel {
    ...
    async _handleSavePdf(html) {
        try {
            ...
            vscode.window.showInformationMessage(`Report opened in your browser. Use the Print dialog (${printShortcut}) and select "Save as PDF" to export.`);
